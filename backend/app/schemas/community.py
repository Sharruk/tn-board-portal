...
class ReportCreate(BaseModel):
    ...
    report_category: Optional[str] = Field(default="other", description="Category: wrong_class, wrong_subject, wrong_exam_type, incorrect_metadata, duplicate_paper, missing_pages, unreadable_content, incorrect_content, inappropriate_content, copyright_issue, other")
